...
import {R, ri, pick, chance, clamp} from '../core/rng.js?v=1.5.0';
...
import {addAb} from './ability.js?v=1.5.0';
import {isSP} from './season.js?v=1.5.0';
import {removeTrait} from '../flow/events.js?v=1.5.0';
