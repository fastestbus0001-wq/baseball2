...
import {ri, pick} from '../core/rng.js?v=1.5.0';
import {CPBL_TEAMS} from '../data/teams.js?v=1.5.0';
import {card, choose, board, menuModal} from '../ui/dom.js?v=1.5.0';
import {tlNote} from '../ui/timeline.js?v=1.5.0';
import {ovr, playerType} from './ability.js?v=1.5.0';
import {primaryPos} from './career.js?v=1.5.0';
import {fmtMoney, makeOffers, pickOfferUI, signTo} from './contract.js?v=1.5.0';
