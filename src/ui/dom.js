...
import {renderTraits, traitName} from './traits.js?v=1.5.0';
import {clearAlloc, allocFullClose} from './alloc.js?v=1.5.0';
import {themeModal, applyBigText, applyMobileUI} from './prefs.js?v=1.5.0';
import {DPN, POSN} from '../data/abilities.js?v=1.5.0';
import {TEAM_COLOR, LV} from '../data/teams.js?v=1.5.0';
import {TRAIT_KEYS, TRAIT_FX} from '../data/traits.js?v=1.5.0';
import {playerName, stageLabel} from '../core/state.js?v=1.5.0';
import {salParts, fmtMoney} from '../engine/contract.js?v=1.5.0';
import {roleN, fmtIP, slgOf, baseballERA} from '../engine/season.js?v=1.5.0';
import {honorGroups, yearRanges} from '../engine/career.js?v=1.5.0';
import {playerType, ovr} from '../engine/ability.js?v=1.5.0';
